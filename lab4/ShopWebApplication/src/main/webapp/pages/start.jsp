			...
			<div class="container">
				...
				<div>
					<ul class="nav navbar-nav">
						...
						<s:if test="#session.webshop_user.roleId==2">   <!-- if admin -->
		...
		<div id="startpage_products">
			...
			<table class="table table-striped">
				...
				<s:iterator value="products" status="rowstatus">
					<s:set var="index" value="#rowstatus.index" />
					<tr>
					<s:if test="#rowstatus.odd == true">
						...
						<td class="odd"><s:property value="categories.get(#index).name" /></td>
						...
						<s:if test="#session.webshop_user.roleId==2">
					...
					<s:else>
						...
						<td><s:property value="categories.get(#index).name" /></td>
